  ...
  return (
    <div className="cart_container">
      ...
      <div className="plus_minus_remove_btn_container">
        ...
        <button className="remove_btn" onClick={props.handleAddToCart}>MOVE TO CART</button>
        <button className="remove_btn" onClick={props.handleRemoveToCart}>REMOVE</button>
      </div>
    </div>
  );
}
