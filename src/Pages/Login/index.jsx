...
import { fetchCategory, fetchProducts, fetchSize } from "../../StateManagement/slicer/product/action";
...
export default function LoginPage() {
  ...
  const {sizes,categories,products} = useSelector(state => state.product)
  ...
  async function handleSubmit(e) {
    ...
    if (!email) {
      ...
      dispatch(requestUserForLogin(data))
    }
