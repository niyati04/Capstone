...
export default function TermsConditions() {
  return (
    <div className="same_width_container">
      <div className="about_main_container" style={{fontFamily:"archivoReg"}}>
        <div className="title_subtitle_about_container">
          <p>TERMS&nbsp; &  &nbsp;CONDITIONS</p>
          <p>Welcome to www.teepalette.com!</p>
        </div>
        ...
        <div className="">
          <div className="policy_container text-left">
            <p>
              ...
              the use of Tee Palette's Website, located at
              https://www.teepalette.com/.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use www.teepalette.com if you do
            ...
            <p>
              We employ the use of cookies. By accessing www.teepalette.com, you
              agreed to
            </p>
            ...
            <p>
              Unless otherwise stated, Tee Palette and/or its licensors own the
              intellectual property rights for all material on
              www.teepalette.com. All intellectual property rights are reserved.
              You may access this from www.teepalette.com for your own personal
            ...
            <ul style={{ margin: "0 0 0 2rem" }}>
              <li>Republish material from www.teepalette.com</li>
              <li>
                Sell, rent or sub-license material from www.teepalette.com
              </li>
              <li>
                Reproduce, duplicate or copy material from www.teepalette.com
              </li>
              <li>Redistribute content from www.teepalette.com</li>
            </ul>

            <p>
              Parts of this website offer an opportunity for users to post and
              exchange opinions and information in certain areas of the website.
              Tee Palette does not filter, edit, publish or review Comments
              prior to their presence on the website. Comments do not reflect
              the views and opinions of Tee Palette,its agents and/or
              ...
              applicable laws, Tee Palette shall not be liable for the Comments
            ...
            <p>
              Tee Palette reserves the right to monitor all Comments and to
            ...
            <p>
              You hereby grant Tee Palette a non-exclusive license to use,
            ...
            <p>
              ...
              Tee Palette; and (d) the link is in the context of general
            ...
            <p>
              ...
              by sending an e-mail to Tee Palette. Please include your name,
            ...
            <p>
              No use of Tee Palette's logo or other artwork will be allowed for
              linking absent a trademark license agreement.
            </p>

            <p style={{ textAlign: "left", fontSize: "1.1rem" }}>
              <li><strong>iFrames</strong></li>
            </p>
